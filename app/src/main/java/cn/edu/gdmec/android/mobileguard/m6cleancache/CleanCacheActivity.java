...
public class CleanCacheActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView(){
        ...
        animation = (AnimationDrawable) findViewById(R.id.imgv_transhbin_cacheclean).getBackground();
        ...
        findViewById(R.id.btn_finish_cleancahe).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.imgv_leftbtn:
                finish();
                break;
            case R.id.btn_finish_cleancahe:
                finish();
                break;
        }
    }
